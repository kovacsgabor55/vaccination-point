...
class VaccinatedServiceTest {
    ...
    void setUp() {
        ...
        vaccinationPointEventService.deleteAll();
        ...
        vaccinationPointEventService.save(patientId, createVaccinationPointEventCommand).getId();
    ...
    void saveLast() {
        ...
        assertEquals(null, result.getPatient().getVaccinationPointEvent());
